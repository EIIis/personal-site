    ...
    <div className="App">
      ...
      <div className='Bio-align'>
        <ul className='Erase-bullet'>
          ...
          <li>👨🏽‍💻 Currently working on learning iOS development through <a href="https://www.codepath.org/courses/ios-mobile-development" target="_blank" rel="noopener noreferrer">CodePath</a> and web development (MERN STACK) through <a href="https://fullstackopen.com/" target="_blank" rel="noopener noreferrer">Full Stack Open</a></li>
        </ul>
      </div>
