...
import placeholder from '../assets/dawg.jpeg'
...
const carouselItems = [
  ...
  {
    image: placeholder,
    link: 'https://github.com/EIIis/sTTats',
    title: 'sTaTTs [WIP]',
    tools: '🤫🤫🤫',
    caption: '🤫This is a big project, work is still needed but feel free to look at the code🤫',
  },
];
...
function Temp() {
    return (
      <div>
        ...
        <LowBanner title="2/16 - Made with love <3"/>
      </div>        
    );
  }
